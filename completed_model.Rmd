...
#quantile(results_replication_1000_times_one_dose$without_vaccination_qol_loss,c(0.025,0.975))
#mean(results_replication_1000_times_one_dose$without_vaccination_qol_loss)

#quantile(results_replication_1000_times_two_dose$without_vaccination_qol_loss,c(0.025,0.975))
#mean(results_replication_1000_times_two_dose$without_vaccination_qol_loss)


#quantile(results_replication_1000_times_one_dose$cases_averted_per_dose,c(0.025,0.975))
#mean(results_replication_1000_times_one_dose$without_vaccination_qol_loss)
...
results_replication_1000_times_one_dose <- replicate(1000, simulate_10_iterations(M, CFR, params, vacc_coverage, ve_i = ve_i_1, ve_s = ve_s_1, ve_d = ve_d_1), simplify = FALSE) %>%
  bind_rows()
...
results_replication_1000_times_two_dose <- replicate(1000, simulate_10_iterations(M, CFR, params, vacc_coverage, ve_i = ve_i_2, ve_s = ve_s_2, ve_d = ve_d_2), simplify = FALSE) %>%
  bind_rows()
...
results_replication_1000_times_one_dose %>%
  ...
  group_by(name) %>%
  summarise(value = sprintf("%.3f (%.3f - %.3f)",mean(value),quantile(value, 0.025),quantile(value, 0.975)))%>%
  print(n=Inf)
...
#one dose
vacc_coverage=0
one_dose_0_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_1, ve_s = ve_s_1, ve_d=ve_d_1), simplify = FALSE) %>%
  bind_rows()
one_dose_0_million_doses <- mutate_data(one_dose_0_million_doses)
#two dose
vacc_coverage=0
two_dose_0_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_2, ve_s = ve_s_2, ve_d=ve_d_2), simplify = FALSE) %>%
  bind_rows()
...
one_dose_10_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_1, ve_s = ve_s_1, ve_d=ve_d_1), simplify = FALSE) %>%
  bind_rows()
...
two_dose_10_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_2, ve_s = ve_s_2, ve_d=ve_d_2), simplify = FALSE) %>%
  bind_rows()
...
one_dose_50_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_1, ve_s = ve_s_1, ve_d=ve_d_1), simplify = FALSE) %>%
  bind_rows()
one_dose_50_million_doses <- mutate_data(one_dose_50_million_doses)
#two dose

vacc_coverage=50000000/DRC_population/2
two_dose_50_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_2, ve_s = ve_s_2, ve_d=ve_d_2), simplify = FALSE) %>%
  bind_rows()
...
one_dose_100_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_1, ve_s = ve_s_1, ve_d=ve_d_1), simplify = FALSE) %>%
  bind_rows()
one_dose_100_million_doses <- mutate_data(one_dose_100_million_doses)
#two dose

vacc_coverage=100000000/DRC_population/2
two_dose_100_million_doses <- replicate(1000, simulate_10_iterations(M = M, CFR = CFR, vacc_coverage = vacc_coverage, params = params, ve_i = ve_i_2, ve_s = ve_s_2, ve_d=ve_d_2), simplify = FALSE) %>%
  bind_rows()
